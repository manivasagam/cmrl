...
public class TrainInfoAdapter extends ArrayAdapter<TrainInfo> {
    ...
    public TrainInfoAdapter(Context context,List<TrainInfo> values) {
        super(context, R.layout.train_info_list_item,values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.train_info_list_item, parent, false);
