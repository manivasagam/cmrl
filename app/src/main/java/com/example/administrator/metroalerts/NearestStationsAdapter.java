 ...
 */
public class NearestStationsAdapter extends ArrayAdapter<TrainInfo> {
    private final Context context;
    private final List<TrainInfo> values;

    public NearestStationsAdapter(Context context,List<TrainInfo> values) {
        super(context, R.layout.nearest_station_list_item,values);
